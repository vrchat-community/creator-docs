...
5. Create a new dummy Unity Project
6. Install the latest SDK on the dummy project
7. Copy the newly added SDK/Plugin and associated .META files from the dummy project into your original project
8. Done. Now you can open your upgraded project, and there will be no crash no matter how complex your trigger work!
